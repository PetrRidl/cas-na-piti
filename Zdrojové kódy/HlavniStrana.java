...
public class HlavniStrana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(res.getCount()>0 && res1.getCount() > 0)vypocet();
        ...
        if(Calendar.getInstance().get(Calendar.HOUR_OF_DAY)<8 && kolikVypito> 1000){
            UlozData();
        ...
        if(MainActivity.firstNoti)
        {
            ...
            alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, rano.getTimeInMillis(), AlarmManager.INTERVAL_DAY, pendingIntent);
        }
    ...
    public void UlozData(){
        ...
        DBHistory.insertData(vypito, Integer.valueOf(helper)+1);
